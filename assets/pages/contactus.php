...
<html>
   <head>
      <title>Contact Us | Infinity Computers</title>
      <meta charset="utf-8">
   ...
   <body>
                        ...
                        <form class="form-horizontal" action="contactus.php" method="post">
                           <fieldset>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <input id="cu_name" name="c_name" type="text" placeholder="Your name" class="form-control" required>
                                    <p id="cu-name-validation" style="font-style: italic;color: red;"></p>
                                 </div>
                              </div>
                              <!-- Email input-->
                              <div class="form-group">
                                 <label class="col-md-2 control-label">Your E-mail</label>
                                 <div class="col-md-9">
                                    <input id="cu_email" name="c_email" type="email" placeholder="Your email" class="form-control" required>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                    <textarea class="form-control" id="cu_message" name="c_message" placeholder="Please enter your message here..." rows="5" required></textarea>
                              ...
                              <div class="form-group">
                                 <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary btn-lg" id="cu_submit_btn">Submit</button>
                                 </div>
                              </div>
                           </fieldset>
                        </form>
      ...
      <div class="container-fluid">
         <div class="row footer-top">
            <form class="form-inline" action="contactus.php" method="post">
      ...
      if(isset($_POST['c_name']) && isset($_POST['c_email']) && isset($_POST['c_message'])){
         ...
         $sql="INSERT INTO `users_contact` (`id`, `name`, `email`, `message`) VALUES (NULL, '$name', '$email', '$message')";
         if ($conn->query($sql) === TRUE) {
            echo "<br>New record created successfully<br>";
